...
# Exercise nr.240
# Considering the ClassOne and ClassTwo classes, write the code to verify that ClassTwo is indeed a child of ClassOne, also printing the result to the screen.
class ClassOne(object):
    def __init__(self, p1, p2):
        self.p1 = p1
        self.p2 = p2
